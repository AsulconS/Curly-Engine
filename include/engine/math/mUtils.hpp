 ...
 * @return int 
 */
CURLY_API int absolute(int val);
 ...
 * @return float 
 */
CURLY_API float absolute(float val);
 ...
 * @return float 
 */
CURLY_API int npow(int val, unsigned int exp);
 ...
 * @return float 
 */
CURLY_API unsigned int npow(unsigned int val, unsigned int exp);
 ...
 * @return float 
 */
CURLY_API float npow(float val, unsigned int exp);
 ...
 * @return int 
 */
CURLY_API int clamp(int val, int lBound, int rBound);
 ...
 * @return unsigned int 
 */
CURLY_API unsigned int clamp(unsigned int val, unsigned int lBound, unsigned int rBound);
 ...
 * @return float 
 */
CURLY_API float clamp(float val, float lBound, float rBound);
 ...
 * @return false 
 */
CURLY_API bool isBetween(int val, int lBound, int rBound);
 ...
 * @return false 
 */
CURLY_API bool isBetween(unsigned int val, unsigned int lBound, unsigned int rBound);
 ...
 * @return false 
 */
CURLY_API bool isBetween(float val, float lBound, float rBound);
