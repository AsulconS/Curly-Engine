 ...
 * @return bool 
 */
CURLY_API bool operator==(const Vec2f& l, const Vec2f& r);
 ...
 * @return bool 
 */
CURLY_API bool operator==(const Vec3f& l, const Vec3f& r);
 ...
 * @return bool 
 */
CURLY_API bool operator==(const Vec4f& l, const Vec4f& r);
 ...
 * @return Vec2f 
 */
CURLY_API Vec2f operator+(const Vec2f& l, const Vec2f& r);
 ...
 * @return Vec2f 
 */
CURLY_API Vec2f operator+(const Vec2f& l, const float r);
 ...
 * @return Vec2f 
 */
CURLY_API Vec2f operator+(const float l, const Vec2f& r);
 ...
 * @return Vec3f 
 */
CURLY_API Vec3f operator+(const Vec3f& l, const Vec3f& r);
 ...
 * @return Vec3f 
 */
CURLY_API Vec3f operator+(const Vec3f& l, const float r);
 ...
 * @return Vec3f 
 */
CURLY_API Vec3f operator+(const float l, const Vec3f& r);
 ...
 * @return Vec4f 
 */
CURLY_API Vec4f operator+(const Vec4f& l, const Vec4f& r);
 ...
 * @return Vec4f 
 */
CURLY_API Vec4f operator+(const Vec4f& l, const float r);
 ...
 * @return Vec4f 
 */
CURLY_API Vec4f operator+(const float l, const Vec4f& r);
 ...
 * @return Vec2f& 
 */
CURLY_API Vec2f& operator+=(Vec2f& l, const Vec2f& r);
 ...
 * @return Vec2f& 
 */
CURLY_API Vec2f& operator+=(Vec2f& l, const float r);
 ...
 * @return Vec3f& 
 */
CURLY_API Vec3f& operator+=(Vec3f& l, const Vec3f& r);
 ...
 * @return Vec3f& 
 */
CURLY_API Vec3f& operator+=(Vec3f& l, const float r);
 ...
 * @return Vec4f& 
 */
CURLY_API Vec4f& operator+=(Vec4f& l, const Vec4f& r);
 ...
 * @return Vec4f& 
 */
CURLY_API Vec4f& operator+=(Vec4f& l, const float r);
 ...
 * @return float 
 */
CURLY_API float module(const Vec2f& v);
 ...
 * @return float 
 */
CURLY_API float module(const Vec3f& v);
 ...
 * @return float 
 */
CURLY_API float module(const Vec4f& v);
 ...
 * @return Vec2f 
 */
CURLY_API Vec2f normalize(const Vec2f& v);
 ...
 * @return Vec3f 
 */
CURLY_API Vec3f normalize(const Vec3f& v);
 ...
 * @return Vec4f 
 */
CURLY_API Vec4f normalize(const Vec4f& v);
