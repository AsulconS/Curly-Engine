...
{
    return "exc::WindowException : Window Exception";
}

inline const char* WindowInitException::what() const throw()
{
    return "exc::WindowInitException : Window failed to initialize";
}

inline const char* GLADInitException::what() const throw()
{
    return "exc::GLADInitException : GLAD failed to initialize";
}
